...
export const PERFUMES_MESSAGE = {
  ...
  PERFUME_NAME_LENGTH_MUST_BE_FROM_1_TO_100: 'Perfume name length must be from 1 to 100',
  BRAND_IS_REQUIRED: 'Brand is required',
  DESCRIPTION_IS_REQUIRED: 'Description is required',
  DESCRIPTION_MUST_BE_A_STRING: 'Description must be a string',
  DESCRIPTION_LENGTH_MUST_BE_FROM_10_TO_500: 'Description length must be from 10 to 500',
  IMAGE_URL_IS_REQUIRED: 'Image url is required',
  IMAGE_URL_MUST_BE_A_STRING: 'Image url must be a string',
  PRICE_IS_REQUIRED: 'Price is required',
  PRICE_MUST_BE_A_NUMBER: 'Price must be a number',
  PRICE_MUST_BE_FROM_0_TO_1000000: 'Price must be from 0 to 1000000',
  ...
  VOLUME_MUST_BE_FROM_0_TO_1000000: 'Volume must be from 0 to 1000000',
  TARGET_AUDIENCE_IS_REQUIRED: 'Target audience is required',
  TARGET_AUDIENCE_MUST_BE_A_STRING: 'Target audience must be a string',
  TARGET_AUDIENCE_LENGTH_MUST_BE_FROM_1_TO_100: 'Target audience length must be from 1 to 100',
